...
GENERIC_PSEUDO_ATOMS = [
    ...
    ['Hw     '    ,'yes'     ,'H '    ,'H '    ,'0'           ,'1.00794 '   ,' 0.52422'   ,'0.0'          ,'1.0'      ,'1.00 '  ,'1'            ,'0'           ,'relative'           ,'0'],
    ['M      '    ,'no'      ,'M '    ,'- '    ,'0'           ,'0.0     '   ,'-1.04844'   ,'0.0'          ,'1.0'      ,'1.00 '  ,'1'            ,'0'           ,'relative'           ,'0'],
...
GENERIC_FF_MIXING = [
    ...
    ['N_com   '      , 'none         '    ,'       '    ,'      '],
    ['Ow      '      , 'lennard-jones'    ,'81.90  '    ,'3.1643'],
    ['Hw      '      , 'lennard-jones'    ,'22.1662'   ,'2.5711'],
