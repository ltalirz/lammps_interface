UFF4MOF_DATA = {
    ...
    "Mo3f2": (1.24, 109.47, 3.052, 0.056, 12, 3.4, 0, 0.2, 3.465, 3.755, 1.53), # CN 4 (is 8 in paper, but received e-mail confirmation)
    ...
    "W_8f4": (1.27, 109.47, 3.069, 0.067, 12, 3.7, 0, 0.1, 4.63, 3.31, 1.538), # CN 8 (is 4 in paper, but received e-mail confirmation) 
